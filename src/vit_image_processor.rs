...
struct Config {
    ...
    pub norm_mean: (f64, f64, f64),
    pub norm_std: (f64, f64, f64),
}
    ...
    img.into_rgba8()
        ...
        .for_each(|(x, y, pixel)| {
            let rescaled_pixel = image::Rgb([
                ((pixel[0] as f64 * CONFIG.rescale_factor - CONFIG.norm_mean.0) / CONFIG.norm_std.0) as f32,
                ((pixel[1] as f64 * CONFIG.rescale_factor - CONFIG.norm_mean.1) / CONFIG.norm_std.1) as f32,
                ((pixel[2] as f64 * CONFIG.rescale_factor - CONFIG.norm_mean.2) / CONFIG.norm_std.2) as f32,
            ]);

...
fn main() {
    ...
    let cpp_lib_path_vs = current_dir.join("cpp/build-x64-windows-vulkan-release/lib/static/Release");
    ...
    println!("cargo:rustc-link-search=native={}", cpp_lib_path_vs.display());
